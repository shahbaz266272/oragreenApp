 ...
 */
export async function sendPromotionalNotification(pushToken, title, message, offerLink) {
  return await sendExpoNotification(
    pushToken,
    title,
    message,
 ...
 */
export async function sendCartReminderNotification(pushToken, cartTotal, itemCount) {
  return await sendExpoNotification(
    pushToken,
 ...
 */
export async function sendDeliveryNotification(pushToken, orderId, estimatedTime) {
  return await sendExpoNotification(
    pushToken,
    '🚚 Out for Delivery',
